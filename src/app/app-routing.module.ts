...
const routes: Routes = [
  ...
  { path: 'notifysetup', loadChildren: './notifysetup/notifysetup.module#NotifysetupPageModule' },
  { path: 'information/:id', loadChildren: './information/information.module#InformationPageModule' },
